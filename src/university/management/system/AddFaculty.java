...
public class AddFaculty extends JFrame implements ActionListener {
    ...
    AddFaculty(){
        ...
        JLabel cour=new JLabel("Qualification");
...
//        cancel.setOpaque(true);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==submit){
            ...
            String department=(String)cbran.getSelectedItem();
            
            try{
                String query="insert into teacher values('"+name+"','"+fname+"','"+id+"','"+dob+"','"+address+"','"+phone+"','"+email+"','"+x+"','"+xii+"','"+aadhar+"','"+qualification+"','"+department+"')";
