...
public class UpdateStudentDetail extends JFrame implements ActionListener {
    ...
    UpdateStudentDetail(){
        ...
        troll.setFont(new Font("serif",Font.PLAIN,20));
        add(troll);
        ...
        try{
            ...
            while(rs.next()){
                ...
                cbran.setText(rs.getString("branch"));
...
//        cancel.setOpaque(true);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==submit){
            ...
            try{
                String query="update student set name='"+name+"',fname='"+fname+"',address='"+address+"',phone='"+phone+"',email='"+email+"',aadhar='"+aadhar+"',course='"+course+"',branch='"+branch+"'where rollno='"+rollno+"'";
